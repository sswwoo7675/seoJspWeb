...
import seoJspWeb.DBConnectionMgr;
...
public class BoardMgr {
	...
	private static final String SAVEFOLDER = "C:/Jsp/seoJspWeb/WebContent/board/fileupload";//C:\jsp\jspStudy\WebContent\ch15\fileupload
	...
	public void post1000(){
		...
		try {
			con = pool.getConnection();
			sql = "insert tblBoard(name,content,subject,ref,pos,depth,regdate,pass,count,ip,filename,filesize)";
			sql+="values('test형님', 'bbb', 'ccc', 0, 0, 0, now(), '1111',0, '127.0.0.1', null, 0);";
			pstmt = con.prepareStatement(sql);
